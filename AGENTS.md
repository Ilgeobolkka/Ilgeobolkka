...
- 프로젝트명: Ilgeobolkka
- 목표: 실제 열람 확정된 페이지에 사용한 포인트를 도서 가격까지 누적하고 소장으로 전환하는 반응형 웹 MVP
...
- 핵심 불변식: 사용자·도서·페이지별 최초 1회만 최대 50P를 차감하고, 도서별 누적 차감은 도서 가격을 넘지 않으며 가격 도달 시 소장 처리하고, 포인트 잔액과 내역 합계를 일치시킨다

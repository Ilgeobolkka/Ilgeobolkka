...
| [0014](./application/0014-use-openai-and-mysql-for-ai-route-generation.md) | OpenAI와 MySQL 기반 AI 잉크 경로 | 대체됨 |
| [0015](./application/0015-harden-openai-ai-route-generation.md) | AI 잉크 경로 신뢰·비용·평가 경계 강화 | 대체됨 |
| [0016](./application/0016-simplify-openai-ai-route-for-mvp.md) | 구현 우선 AI 잉크 경로 | 승인됨 |

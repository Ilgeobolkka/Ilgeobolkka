#!/usr/bin/env python3
"""book-088 이미지 페이지 6개의 SVG 생성. 색 토큰과 t()·base()는 figure_lib에서 가져온다.
...
from figure_lib import (W, INK, SOFT, MUTED, KEEP, DROP, MARK,
                        MARKER_KEEP, MARKER_MARK, caption, make_base, note_box, t)

WATER = "#8fb2c4"

WATER_MARKER = (f'  <marker id="water" markerWidth="9" markerHeight="9" refX="8" refY="3" '
                f'orient="auto"><path d="M0,0 L0,6 L8,3 z" fill="{WATER}"/></marker>\n')
base = make_base(MARKER_KEEP + MARKER_MARK + WATER_MARKER)

#!/usr/bin/env python3
"""book-090 이미지 페이지 6개의 SVG 생성. 색 토큰과 t()·base()는 figure_lib에서 가져온다.
...
from figure_lib import INK, LINE, SOFT, MUTED, KEEP, MARK, DEFAULT_DEFS, caption, make_base, note_box, t

PATTERNS = f'''  <pattern id="gravel" width="14" height="14" patternUnits="userSpaceOnUse">
...
'''
base = make_base(DEFAULT_DEFS + PATTERNS)

...
애플리케이션의 `store=false`가 유효한 차단 경계입니다. 이 Q01 실행 직후에는 월 지출액 `$10.00`만
설정되고 `Enforce a hard limit`가 꺼져 있었습니다. 후속 작업에서 2026-08-18 14:33 KST에 강제 상한을
켜서 저장하고 설정 창을 다시 열어 활성 상태를 확인했습니다. 상세 근거는

...
원시 artifact는 Git 제외 `var/performance/` 아래에 보존한다. 정식 Average·Peak의 작은 k6
`summary.json`은 아래 표의 `Git summary` 이름으로 원본과 같은 bytes를 커밋했다. 비밀번호·cookie·CSRF
token·session ID와 DB 접속 문자열은 문서에 기록하지 않았고, 원시 진단 파일의 민감 패턴 검사도 통과했다.
...
| 결과 디렉터리 | Git summary | summary.json SHA-256 | metadata.json SHA-256 |
| --- | --- | --- | --- |
| `20260811T100245Z-baseline-average-r1` | `summary-run-average-1.json` | `e48e480fefe7e78c4d5d05543a22a6d6d1dd8c37ffe3d74bdc4ef0e32fca4b5e` | `aea2b74dc4cbb95873fda90cc47c68a23e88e2f1b490d16b731a1b08a92c2e0e` |
| `20260811T101632Z-baseline-average-r2` | `summary-run-average-2.json` | `b5ed4e5110aa47052153abbe23b314f64232f4146766739cffd5e9a5b5a6fb36` | `95b2bff85e5686872f11785c8fb57facac8b2093949d88ebacbfa58346ea0d23` |
| `20260811T103017Z-baseline-average-r3` | `summary-run-average-3.json` | `a635c64524de87d15e7879616060045f3923e5c19502578f8ee061214fedc37a` | `a22dc0145d0c44fe54fc9e5eb7163a7d54c9bb18a04ad91ec36fe05bd631dccd` |
| `20260811T104427Z-baseline-peak-r1` | `summary-run-peak-1.json` | `4f730ec51fc6272c602f62b8dc58c02b87ca5a811d9a9b0275fa9d0249d028d7` | `5293091d6cc2850e7b4d0f978d7c0f036e0313bae122d9f94c677eeb545d1356` |
| `20260811T105816Z-baseline-peak-r2` | `summary-run-peak-2.json` | `c30e34b71c0b9abce7f06697301d15aa36b7f425902a8139e704dfc78eccb1b3` | `67502fa9316b7807036ea065d4cde6705beb8a52f31b2b722580ee8d69a44f90` |
| `20260811T111201Z-baseline-peak-r3` | `summary-run-peak-3.json` | `a9dc487f15d79653112ec405aa4806a47b410f1363611647570872d5ac737864` | `b80ae1a4c779823db85d86e5a8d01b90910b4cd733df7bcb4dca9182fd83ecd6` |

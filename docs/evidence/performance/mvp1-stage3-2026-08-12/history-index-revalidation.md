...
2026-08-12 사용자 확인으로 고정 15% 전체 p95 하한을 인덱스 채택 조건에서 폐기했다. 실제 제품 SQL에서
기본 optimizer가 새 index를 선택하고 이력 증가에 비례하던 읽기와 정렬을 의미 있게 줄이며, 같은 조건의
반복 측정에서 대상 endpoint의 p50·p95가 모든 회차에서 개선되고 정확성·오류·쓰기 흐름에 회귀가 없으면
채택한다.

...
[PRD 색인](../../prd/README.md)으로 돌아갑니다. 이 폴더는 정본상 아직 구현 전인 AI 잉크 경로 2차 MVP만
AI 코딩 작업으로 나눈 실행 안내입니다. 정책·API·스키마·테스트 값과 구현 진행 상태의 정본이 아닙니다.
...
| F05 | [Responses HTTP adapter](./foundation/F05-responses-adapter.md) | F03, [GATE-AIR-02](./00-implementation-gates.md#gate-air-02-후보prompt-정책-v1) | strict 구조화 출력 Gateway |
...
| G02 | [cosine 후보 검색](./generation/G02-candidate-search.md) | G01, [GATE-AIR-02](./00-implementation-gates.md#gate-air-02-후보prompt-정책-v1) | 후보 정렬·허용 후보 집합 |
| G03 | [모델 출력 검증](./generation/G03-output-validation.md) | F05, [GATE-AIR-02](./00-implementation-gates.md#gate-air-02-후보prompt-정책-v1) | 전체 거부형 output validator |

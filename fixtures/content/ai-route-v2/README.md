...
47개 중 11개가 60초다. 남은 80권은 **페이지당 330자 이상**을 기준으로 삼아 이 쏠림을 없앤다.
500자 이상을 목표로 적어 두었다가 book-044 파일럿에서 다시 못 지켜 기준을 고쳤다. 실제로 막아야 할
것은 60초로 눌리는 것이고 그 문턱은 330자다. 373~565자로 쓴 book-044는 60초 페이지가 하나도 없어
기준이 겨냥한 문제가 해결됐다. 지킬 수 없는 수치를 적어 두면 다음 도서도 계속 못 지킨다.

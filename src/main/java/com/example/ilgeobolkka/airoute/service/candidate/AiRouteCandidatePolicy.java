...
/**
 * 후보 정책 {@code air-candidate-v2}의 고정 값.
 *
...
public final class AiRouteCandidatePolicy {
    ...
    public static final String VERSION = "air-candidate-v2";

    /** 후보로 남길 최소 cosine similarity. 정확히 이 값은 포함한다. */
    public static final double MINIMUM_SIMILARITY = 0.15;

    /** 정렬 뒤 남길 후보 최대 개수. */
    public static final int MAXIMUM_CANDIDATES = 40;

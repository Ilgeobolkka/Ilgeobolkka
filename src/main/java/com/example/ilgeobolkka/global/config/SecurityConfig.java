...
public class SecurityConfig {
    ...
    private static final RequestMatcher PUBLIC_BOOKS = pathPattern(HttpMethod.GET, "/api/books/**");
    ...
    SecurityFilterChain securityFilterChain(
        ...
        http
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers(SIGNUP, LOGIN, PUBLIC_BOOKS, PORTONE_WEBHOOK).permitAll()
